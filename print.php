<?php 
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10," Npsahasin engineering LTD",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"9/885 Moo 5 Theparak road KM.8 T.Praksa A.Muang Samutprakarn ",0,1);
      $this->Cell(50,7,"10280 TEL.089-4779901 Taxpayer number:0125542006492  ",0,1);
      $this->Cell(50,7,"E-Mail:npsahasin@yahoo.co.th",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for Npsahasin engineering LTD",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
      ...
      //Display Footer Text
      $this->Cell(0,10,"This is a metal lathe invoice",0,1,"C");
